...
SRC_URI="
https://api.github.com/repos/docker/model-runner/tarball/v1.2.3 -> docker-model-1.2.3-ddb50c9.tar.gz
mirror://macaroni/docker-model-1.2.3-mark-go-bundle-ddb50c9.tar.xz -> docker-model-1.2.3-mark-go-bundle-ddb50c9.tar.xz"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="*"
...
src_compile() {
	...
	local cli_ldflags=(
	  "-X \"github.com/docker/model-runner/cmd/cli/desktop.Version=1.2.3\""
	)
