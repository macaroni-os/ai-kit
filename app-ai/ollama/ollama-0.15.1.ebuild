...
DESCRIPTION="Get up and running with OpenAI GLM-4.7, DeepSeek, gpt-oss, Qwen, Gemma and other models."
HOMEPAGE="https://ollama.com"
SRC_URI="
https://api.github.com/repos/ollama/ollama/tarball/v0.15.1 -> ollama-0.15.1-465d124.tar.gz
mirror://macaroni/ollama-0.15.1-mark-go-bundle-465d124.tar.xz -> ollama-0.15.1-mark-go-bundle-465d124.tar.xz"
LICENSE="MIT"
SLOT="0"
KEYWORDS="*"
IUSE="systemd"
