...
SRC_URI="https://api.github.com/repos/ggml-org/llama.cpp/tarball/b9968 -> llama-cpp-0.0.9968-1d1d9a9.tar.gz"
LICENSE="MIT"
SLOT="0"
KEYWORDS="*"
...
src_configure() {
	...
	export BUILD_COMMIT=1d1d9a9ed7a4f09c4225ea4cc8fd3bd1cf2c940f
	 local mycmakeargs=(
