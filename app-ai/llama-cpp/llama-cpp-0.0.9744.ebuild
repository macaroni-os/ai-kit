...
SRC_URI="https://api.github.com/repos/ggml-org/llama.cpp/tarball/b9744 -> llama-cpp-0.0.9744-063d9c1.tar.gz"
LICENSE="MIT"
SLOT="0"
KEYWORDS="*"
...
src_configure() {
	...
	export BUILD_COMMIT=063d9c156e816ae3cf62db01f429a07a099afe97
	 local mycmakeargs=(
