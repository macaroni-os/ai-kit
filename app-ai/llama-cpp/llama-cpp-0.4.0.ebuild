...
SRC_URI="https://api.github.com/repos/ggml-org/llama.cpp/tarball/v0.4.0 -> llama-cpp-0.4.0-427291b.tar.gz"
LICENSE="MIT"
SLOT="0"
KEYWORDS="*"
IUSE="static blas cuda nccl vulkan cuda-native
cuda_sm_50
cuda_sm_52
cuda_sm_60
cuda_sm_61
...
src_configure() {
	...
	export BUILD_COMMIT=427291b5b34cd914a31b3fd3b61a68f6184f4b9f
	 local mycmakeargs=(
